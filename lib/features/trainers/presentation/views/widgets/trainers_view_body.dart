import 'package:fetra/core/shared_widgets/trainer_tabs.dart';
  ...
  Widget build(BuildContext context) {
    return  Column(
      children: [
        ...
        SizedBox(height: AppConstants.height20(context),),
        BlocBuilder<GetAllTrainersCubit,GetAllTrainersState>(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> CoachProfileView(id: AppConstants.foundedTrainers[index].id.toString(),)));
                      },child: CoachItem(instance: AppConstants.foundedTrainers[index],));
