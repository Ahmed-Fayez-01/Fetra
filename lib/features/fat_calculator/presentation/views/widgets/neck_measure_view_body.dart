...
import 'package:fetra/features/fat_calculator/presentation/views/middle_measure_view.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class NeckMeasureViewBody extends StatelessWidget {
  const NeckMeasureViewBody({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.symmetric(horizontal: AppConstants.width20(context)),
          child: Text("The smallest neck measurement is taken below the larynx (Adam's apple).",style: TextStyle(
              fontWeight: FontWeight.w500,
